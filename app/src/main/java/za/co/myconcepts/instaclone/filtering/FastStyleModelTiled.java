...
import za.co.myconcepts.instaclone.ScriptC_img2alloc;
import za.co.myconcepts.instaclone.ScriptC_network;
...
public class FastStyleModelTiled {
    ...
    public static int MAX_IMG_SIZE = 256;
    public static int MAX_CHUNK_SIZE = 256;
